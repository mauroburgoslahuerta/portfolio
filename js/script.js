...
const projectsData = {
    "edutestia-app": {
        ...
        "shortDesc": {
            "es": "Plataforma de desarrollo propio que transforma cualquier tema en un test educativo con imágenes en segundos.",
            "gl": "Plataforma de desarrollo propio que transforma cualquier tema en un test educativo con imágenes en segundos.",
            "en": "Plataforma de desarrollo propio que transforma cualquier tema en un test educativo con imágenes en segundos."
        },
        "desc": {
            "es": "Crea tests educativos con imágenes en segundos. <strong>El objetivo no es automatizar la educación a ciegas</strong>, sino facilitar la creación de materiales manteniendo siempre el control: <strong>la IA propone los borradores, pero el creador revisa, ajusta y valida el contenido antes de compartirlo.</strong><br><br><strong>Filosofía y Mecánicas:</strong><div style='display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 10px; margin-top: 10px;'><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1);'><strong style='display:block; margin-bottom:4px;'>🧠 Aprendizaje Adaptativo</strong>Ajusta dinámicamente lenguaje y dificultad, sin necesidad de programación manual.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1);'><strong style='display:block; margin-bottom:4px;'>🛡️ Enfoque Pedagógico</strong>Los temas sensibles no se censuran, se reformulan priorizando la reflexión y la convivencia.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1);'><strong style='display:block; margin-bottom:4px;'>✨ Control Consciente</strong>Edición total de preguntas, respuestas e imágenes. Ningún contenido se publica sin validación.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1);'><strong style='display:block; margin-bottom:4px;'>📈 Aprender Haciendo</strong>El error no penaliza. Se registra el primer y último intento para fomentar la mejora continua.</div></div><br><br>Plataforma en producción con modelo freemium: acceso gratuito con imágenes de banco de fotos, y suscripción de pago para generación de imágenes por IA.",
            "gl": "Crea tests educativos con imágenes en segundos. <strong>El objetivo no es automatizar la educación a ciegas</strong>, sino facilitar la creación de materiales manteniendo siempre el control: <strong>la IA propone los borradores, pero el creador revisa, ajusta y valida el contenido antes de compartirlo.</strong><br><br><strong>Filosofía y Mecánicas:</strong><div style='display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 10px; margin-top: 10px;'><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1);'><strong style='display:block; margin-bottom:4px;'>🧠 Aprendizaje Adaptativo</strong>Ajusta dinámicamente lenguaje y dificultad, sin necesidad de programación manual.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1);'><strong style='display:block; margin-bottom:4px;'>🛡️ Enfoque Pedagógico</strong>Los temas sensibles no se censuran, se reformulan priorizando la reflexión y la convivencia.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1);'><strong style='display:block; margin-bottom:4px;'>✨ Control Consciente</strong>Edición total de preguntas, respuestas e imágenes. Ningún contenido se publica sin validación.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1);'><strong style='display:block; margin-bottom:4px;'>📈 Aprender Haciendo</strong>El error no penaliza. Se registra el primer y último intento para fomentar la mejora continua.</div></div><br><br>Plataforma en produción con modelo freemium: acceso gratuíto con imaxes de banco de fotos, e subscrición de pago para xeración de imaxes por IA.",
            "en": "Crea tests educativos con imágenes en segundos. <strong>El objetivo no es automatizar la educación a ciegas</strong>, sino facilitar la creación de materiales manteniendo siempre el control: <strong>la IA propone los borradores, pero el creador revisa, ajusta y valida el contenido antes de compartirlo.</strong><br><br><strong>Filosofía y Mecánicas:</strong><div style='display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 10px; margin-top: 10px;'><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1);'><strong style='display:block; margin-bottom:4px;'>🧠 Aprendizaje Adaptativo</strong>Ajusta dinámicamente lenguaje y dificultad, sin necesidad de programación manual.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1);'><strong style='display:block; margin-bottom:4px;'>🛡️ Enfoque Pedagógico</strong>Los temas sensibles no se censuran, se reformulan priorizando la reflexión y la convivencia.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1);'><strong style='display:block; margin-bottom:4px;'>✨ Control Consciente</strong>Edición total de preguntas, respuestas e imágenes. Ningún contenido se publica sin validación.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1);'><strong style='display:block; margin-bottom:4px;'>📈 Aprender Haciendo</strong>El error no penaliza. Se registra el primer y último intento para fomentar la mejora continua.</div></div><br><br>Production platform with a freemium model: free access with stock photos, and paid subscription for AI image generation."
        },
        "objectives": {
            "es": [
