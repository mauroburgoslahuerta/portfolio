...
const projectsData = {
    "aventuria-app": {
        ...
        "desc": {
            "es": "<strong>AventurIA</strong> transforma cualquier tema en una experiencia educativa interactiva. Su objetivo no es automatizar la educación, sino empoderar al creador: <strong>la IA propone, pero el criterio final siempre es humano.</strong><br><br><strong>Filosofía y Mecánicas:</strong><div style='display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 10px; margin-top: 10px;'><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border-left: 4px solid #F4C430;'><strong style='display:block; margin-bottom:4px;'>🧠 Aprendizaje Adaptativo</strong>Ajusta dinámicamente lenguaje y dificultad, sin necesidad de programación manual.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border-left: 4px solid #2196F3;'><strong style='display:block; margin-bottom:4px;'>🛡️ Enfoque Pedagógico</strong>Los temas sensibles no se censuran, se reformulan priorizando la reflexión y la convivencia.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border-left: 4px solid #9C27B0;'><strong style='display:block; margin-bottom:4px;'>✨ Control Consciente</strong>Edición total de preguntas, respuestas e imágenes. Ningún contenido se publica sin validación.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border-left: 4px solid #4CAF50;'><strong style='display:block; margin-bottom:4px;'>📈 Aprender Haciendo</strong>El error no penaliza. Se registra el primer y último intento para fomentar la mejora continua.</div></div>",
            "gl": "<strong>AventurIA</strong> transforma calquera tema nunha experiencia educativa interactiva. O seu obxectivo non é automatizar a educación, senón empoderar ao creador: <strong>a IA propón, pero o criterio final sempre é humano.</strong><br><br><strong>Filosofía e Mecánicas:</strong><div style='display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 10px; margin-top: 10px;'><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border-left: 4px solid #F4C430;'><strong style='display:block; margin-bottom:4px;'>🧠 Aprendizaxe Adaptativo</strong>Axusta dinamicamente linguaxe e dificultade, sen necesidade de programación manual.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border-left: 4px solid #2196F3;'><strong style='display:block; margin-bottom:4px;'>🛡️ Enfoque Pedagóxico</strong>Os temas sensibles non se censuran, reformúlanse priorizando a reflexión e a convivencia.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border-left: 4px solid #9C27B0;'><strong style='display:block; margin-bottom:4px;'>✨ Control Consciente</strong>Edición total de preguntas, respostas e imaxes. Ningún contido publícase sen validación.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border-left: 4px solid #4CAF50;'><strong style='display:block; margin-bottom:4px;'>📈 Aprender Facendo</strong>O erro non penaliza. Rexístrase o primeiro e último intento para fomentar a mellora continua.</div></div>",
            "en": "<strong>AventurIA</strong> transforms any topic into an interactive educational experience. Its goal is not to automate education, but to empower the creator: <strong>AI proposes, but the final judgment is always human.</strong><br><br><strong>Philosophy & Mechanics:</strong><div style='display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 10px; margin-top: 10px;'><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border-left: 4px solid #F4C430;'><strong style='display:block; margin-bottom:4px;'>🧠 Adaptive Learning</strong>Dynamically adjusts language and difficulty without manual programming.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border-left: 4px solid #2196F3;'><strong style='display:block; margin-bottom:4px;'>🛡️ Pedagogical Approach</strong>Sensitive topics are not censored, they are reframed prioritizing ethics and reflection.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border-left: 4px solid #9C27B0;'><strong style='display:block; margin-bottom:4px;'>✨ Conscious Control</strong>Total editing of questions, answers, and images. No content is published without validation.</div><div style='background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border-left: 4px solid #4CAF50;'><strong style='display:block; margin-bottom:4px;'>📈 Learning by Doing</strong>Mistakes are not penalized. First and last attempts are recorded to foster continuous improvement.</div></div>"
        },
        "objectives": {
            "es": [
